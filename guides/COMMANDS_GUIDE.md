# 📜 Full Command Reference (Commands Guide)

**Immortality: The Path of Cultivation** provides command sets for players, administrators, structure generation, and entity summoning.
...
- **`pedestal_shrine`**: A Jade Pedestal shrine with a central Infusion Altar and 4 3D pedestals.
